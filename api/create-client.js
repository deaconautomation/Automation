...
<div style="max-width:520px;margin:40px auto;background:#0e1017;border:1px solid rgba(129,140,248,.13);border-radius:16px;overflow:hidden">
  ...
  <div style="padding:28px 32px">
    ...
    <p style="color:#8b90b8;font-size:14px;line-height:1.6;margin:0 0 24px">
    ...
    <div style="background:#161820;border:1px solid rgba(129,140,248,.13);border-radius:10px;padding:16px 20px;margin-bottom:24px">
      <div style="margin-bottom:10px">
        <div style="font-size:11px;text-transform:uppercase;letter-spacing:.05em;color:#8b90b8;margin-bottom:3px">Email</div>
        <div style="color:#e8eaf6;font-size:14px;font-weight:600">${email}</div>
      </div>
      <div>
        <div style="font-size:11px;text-transform:uppercase;letter-spacing:.05em;color:#8b90b8;margin-bottom:3px">Password</div>
        <div style="color:#e8eaf6;font-size:14px;font-weight:600;font-family:monospace">${password}</div>
      </div>
    </div>
